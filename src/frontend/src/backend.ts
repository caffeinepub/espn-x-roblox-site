...
export class Backend implements backendInterface {
    ...
    async getAllPlayerCards(): Promise<Array<PlayerCard>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPlayerCards();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllRobloxGames(): Promise<Array<RobloxGame>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRobloxGames();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllScoreboardEntries(): Promise<Array<ScoreboardEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllScoreboardEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
